package co.com.amway.httpwww.inventariosamway.adapter;
...
import co.com.amway.httpwww.inventariosamway.view.PictureDeatilActivity;

/**
 * Created by Alguien on 18/04/2017.
 */
    ...
    public void onBindViewHolder(PictureViewHolder holder, int position) {
        ...
        holder.pictureCard.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(activity, PictureDeatilActivity.class);
